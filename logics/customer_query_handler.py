...
def identify_category_and_courses(user_message):
    ...
    category_and_product_response_str = llm.get_completion_from_messages(messages)
...
def get_course_details(category_and_product_response):
    course_names_list = []
...
def generate_response_based_on_course_details(user_message, product_details):
    ...
    For step 3, DO NOT end your response with {delimiter}
    """
...
# String the functions above into a main function
# For challenge 3, modify output to return course_details which will be displayed as df
